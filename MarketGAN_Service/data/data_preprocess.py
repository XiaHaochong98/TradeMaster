...
def get_tics_PM(path):
    pass

def conditional_dataset_preprocessing_PM(path,tics,args,tic_tokenizer,dynamics_tokenizer,features):
    pass
# TODO:
#     # get all folder names under path
#

# TODO: add histrocial data as another condition to the dataset
# TODO: use histrocial to normalize the data
...
def dataset_preprocessing(data_file_path, tics, args, tic_tokenizer, dynamics_tokenizer, features,history_length):
    ...
    for tic in tqdm(tics):
        ...
        for j in range(regime_num):
            ...
            data_samples,historcial_samples,time,scaler_vec,last_hist_vec,original_data_samples,original_history_samples= data_sample_worker(data_seg, args.max_seq_len, features, history_length, data, args.differential_features) # list of dataframes dim: (n,seq_len,features) time: (n,1)
