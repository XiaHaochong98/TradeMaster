...
def data_preprocessing_for_condition_discrimination(history_data_rescaled, generated_data_samples, last_hist_vec, features, differential_features=True):
    # processed the data into encoding format for condition discriminator
    # print('history_data_rescaled.shape',history_data_rescaled.shape)
    # print('generated_data_samples.shape',generated_data_samples.shape)
    # print('last_hist_vec.shape',last_hist_vec.shape)
    ...
    for index, generated_data_sample in enumerate(generated_data_samples):
        ...
        try:
            ...
            if differential_features:
                ...
                # if index==0:
                #     print('last_low_befor_data_sample',last_low_befor_data_sample)
                #     print('data_sample_low',data_sample['low'][:5])
                #     print('index data_sample_low_diff',index,data_sample_low_diff[:5])
