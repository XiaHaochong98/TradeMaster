...
class SupervisorNetwork(torch.nn.Module):
    def __init__(self, args):
        ...
        print(f'Supervisor use TimesNet: {self.use_TimesNet}, addtional RNN: {self.use_RNN}, add_history:{self.args.add_history}')
...
class SupervisorRNN(torch.nn.Module):
    ...
    def forward(self, H, T, D=None, L=None,History=None):
        ...
        if History is not None:
            # print('History.shape',History.shape,'H_o.shape',H_o.shape)
