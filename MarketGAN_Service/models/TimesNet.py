    ...
    def forward(self, x):
        ...
        for i in range(self.k):
            ...
            if (self.seq_len + self.pred_len) % period != 0:
                ...
                out = x
            # reshape
            # print('period_list',period_list,'period_weight',period_weight.shape)
            # print('out.shape',out.shape,B, length, period,N)
...
class TimesNet(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc):
        ...
        # print('enc_out after embedding:',enc_out.permute(0, 2, 1).shape)
        enc_out = self.predict_linear(enc_out.permute(0, 2, 1)).permute(
            0, 2, 1)  # align temporal dimension
        # TimesNet
        # print('enc_out after timesnet:',enc_out.shape)
        ...
        #
        # print(dec_out.shape)
        # print((stdev[:, 0, :].unsqueeze(1).repeat(
        #               1, self.pred_len + self.seq_len, 1)).shape)
    ...
    def classification(self, x_enc, x_mark_enc):
        ...
        # print('output:',output.shape,'x_mark_enc:',x_mark_enc.shape)
    ...
    # def encoding(self, x_enc, x_mark_enc,condition_features=None):
    #     # embedding
    #     # x_enc is concatenated with conditional features
    #     # x_enc shape: [B, T, N + C]
    #     if condition_features is not None:
    #         enc_out = self.enc_embedding(x_enc, None, condition_features)
    #     else:
    ...
    def forward(self, x_enc, x_mark_enc=None,condition_features=None):
        ...
        #     return dec_out  # [B, L, D]
        # x_enc: [B, T, D] x_mark_enc: [B, T] of ones
