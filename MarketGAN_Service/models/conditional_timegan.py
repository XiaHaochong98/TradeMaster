...
class Conditional_TimeGAN(torch.nn.Module):
    ...
    def __init__(self, args, dynamic_supervisor_args, label_supervisor_args):
        ...
        # if args.use_RNN:
        #     latent_dynamic_supervisor_args.model = 'RNN'
        # if args.use_TimesNet:
        #     latent_dynamic_supervisor_args.model = 'TimesNet'
        ...
        # latent_dynamic_supervisor_args.use_TimesNet = True
        # latent_dynamic_supervisor_args.use_RNN= False
        ...
        # if args.use_RNN:
        #     latent_label_supervisor_args.model = 'RNN'
        # if args.use_TimesNet:
        #     latent_label_supervisor_args.model = 'TimesNet'
        latent_label_supervisor_args.model = args.latent_condtion_supervisor_model
        # latent_label_supervisor_args.use_TimesNet = True
        # latent_label_supervisor_args.use_RNN = False
    ...
    #         D_loss = torch.nn.functional.binary_cross_entropy(D_hat, D)
    #
    #         dynamic_prediction_latent = self.latent_dynamic_revovery(H, T, D=D, L=L, H=History_embbedding)
    #         # print('dynamic_prediction_latent',dynamic_prediction_latent.shape,'D',D.shape)
    #         Dynamics_loss_latent = torch.nn.functional.binary_cross_entropy(dynamic_prediction_latent, D)
    #
    #     if L is not None:
    ...
    #         L_loss = torch.nn.functional.binary_cross_entropy(L_hat, L)
    #
    #         label_prediction_latent = self.latent_label_recovery(H, T, D=D, L=L, H=History_embbedding)
    #
    #         Label_loss_latent = torch.nn.functional.binary_cross_entropy(label_prediction_latent, L)
    #
    #
